...
do
    ...
    HCLIB_WORKERS=$w srun -N $nodes -n $((24*$nodes/$w)) ./main_02 -s 20 -d 100 -g 20 -c 0 -o $PWD/bin/a$w.txt
done

HCLIB_WORKERS=1 srun -N $nodes -n $((24*$nodes)) ./main_03 -s 20 -d 100 -g 20 -c 0 -o $PWD/bin/b1.txt
